...
namespace ApsCalc
{
    public class Module
    {
        ...
        public Module(string name, float vMod, float kdMod, float apMod, float cMod, float mLength, Position mType, bool _isChem)
        {
            Name = name;
            VelocityMod = vMod;
        ...
        public static Module HollowPoint { get; } = new Module("Hollow point head", 1.45f, 1.2f, 1.0f, 1.0f, 500, Position.Head, false);
